...
///*
// *  這邊只有針對事件
// *    實作的座一座addMouseListene滑鼠聽到了做兩件事mousePressed  mouseReleased
// */
//
//public class MyPainter3 extends JPanel  {//component抽象 沒有抽象方法想表現出多行
//	private int  x0,y0,x1,y1,x,y,h,w;            //implements MouseListener案左邊直接實作
//	
//	public MyPainter3(){
//		setBackground(Color.DARK_GRAY);
//		addMouseListener(new MouseAdapter(){  //匿名的抽象類別要把父寫的寫完
//			@Override
